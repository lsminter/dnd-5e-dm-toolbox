    ...
    <div className="min-h-screen mx-[24px] text-defaultColor">
      <div className="grid justify-items-center md:grid-cols-2 mt-4 md:mt-10 md:space-x-4">
        ...
        <div className="flex max-w-[572px] justify-items-center">
          <Image 
            src="/images/page-images/home.png" 
            alt="home page image" 
            width={722}
            height={432}
      ...
      >
        <ToolsCard 
          image='/images/page-images/pc.png' 
        ...
        />
        <ToolsCard 
          image='/images/page-images/loot.png' 
        ...
        />
        <ToolsCard 
          image='/images/page-images/npc.png' 
          title="NPC Generator" 
        ...
        />
        <ToolsCard 
          image='/images/page-images/encounter.png' 
